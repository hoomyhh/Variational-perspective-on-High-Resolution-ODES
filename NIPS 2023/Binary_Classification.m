...
mont_iter = 100;%number of Monte-Carlo Simulations
...
% SGD + NNAG
 ...
 L1 = 100;
 L2 = 1000;
 [upperbound_L1,upperbound2_L1,upperbound_Laborde_L1] = upperbounds(t_k_0,k_0,sigma,L1,x0,iter,X,Y,x_star,x_0,v_0,f);
 [upperbound_L2,upperbound2_L2,upperbound_Laborde_L2] = upperbounds(t_k_0,k_0,sigma,L2,x0,iter,X,Y,x_star,x_0,v_0,f);
mont
end
