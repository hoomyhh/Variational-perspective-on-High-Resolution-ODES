...
# The SVRG/SGD & the body implementation were inspired from https://github.com/yueqiw/OptML-SVRG-PyTorch

# For similar results as in the paper use SGD: lr 0.01 SVRG lr 0.01 NNAG lr 0.05 a 150 and all weight decays equal to 0
parser = argparse.ArgumentParser(description="Train SVRG/SGD/NNAG on CIFAR10 data.")
...
if __name__ == "__main__":
    ...
    if not args.optimizer in ['SGD', 'NNAG', 'SVRG']:
        raise ValueError("--optimizer must be 'SGD' or 'NNAG' or 'SVRG'.")
    print(args_dict)
