function [x,error_laborde1] = acc_laborde_sgd_noise(s_k,f,gradf,gradf_i,x0,iter,s,c,d,m,x_star)
...
for i=1:iter
    ...
    %error_laborde(mont,i) = norm(gradf(x1))^2;
    %error_laborde1(mont,i) = min(error_laborde(mont,(1:i)));
